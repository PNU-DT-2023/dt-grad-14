  ...
  return (
    ...
    <div className="w-full min-h-screen font-sans overflow-x-hidden flex flex-col justify-between max-phone:h-fit">
      ...
      <div className="flex mt-5">
        <p className="font-sans ml-5 md:ml-10 mt-3 md:w-2/3" {...animatedItem[6]} >
          Pusan National Univ. Design & Technology
          <br />
          14th Graduation Exhibition
        </p>
        <p className="mt-3 md:mr-10 md:w-1/3 md:flex md:justify-end max-phone:hidden" {...animatedItem[7]}>
      ...
      <span className="mt-12"  {...animatedItem[1]}>
  ...
  function Professors() {
    ...
    return (
      <div className='w-full h-screen text-center flex flex-col items-center justify-center max-phone:h-fit'>
        <div className='text-3xl mb-20 max-phone:mb-10 max-phone:mt-10' {...animatedItem[3]}>Professors</div>
        <div className='w-3/4 flex flex-wrap justify-center  max-phone:justify-center'>
          <div className='relative items-center flex flex-col mr-32' {...animatedItem[0]}>
