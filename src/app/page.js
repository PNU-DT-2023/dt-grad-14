...
export default function Home() {
  ...
  return (
    ...
    <div>
      <h1 className='font-sanserif text-6xl font-bold mt-0 ml-10'>HOMMAGE</h1> 
      <div className='flex'>
      ...
      <div className="relative overflow-hidden space-between pt-32">
      <img src="/hommage-home.svg" alt="hommage_home" className='scale-105 -left-8  h-96'/>
      </div>
      ...
      <div className='bg-black  h-auto w-1/2 text-white'>
        <p className='font-sanserif mx-10 pt-10 font-bold'>전시개요<br /><br /></p>
        <p className='font-sanserif mx-10 pb-10 leading-loose'>
      ...
      <div className='bg-black  h-auto w-1/2 text-white'>
      <p className='font-sanserif mx-10 pt-10 font-bold'>전시기간<br /><br /></p>
      <p className='font-sanserif mx-10 pb-10 leading-loose'>
        11.10(FRI) - 11.12<br />
        opening 11.10(FRI) 19:00 <br />
      </p>
      <p className='font-sanserif mx-10 font-bold'>전시장소<br /><br /></p>
      <p className='font-sanserif mx-10 pb-10 leading-loose'>
